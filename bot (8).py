...
async def hilfe(interaction: discord.Interaction):
    embed = discord.Embed(title="📖 NEXUS COMMUNITY BOT v17.0 — Befehle", color=0x00f5ff)
    ...
    embed.add_field(name="📱 TikTok", value="`/tiktok-liste` — wer wird überwacht\nVerwaltung: `/tiktok-überwachen` *(Owner)*", inline=False)
    ...
    if ist_owner(interaction.user.id):
        ...
        embed.add_field(
            ...
            value=(
                ...
                "`/voice-stimme-wählen`\n"
                "`/tiktok-überwachen` `/tiktok-nicht-mehr-überwachen`\n"
